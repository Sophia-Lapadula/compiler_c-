...
typedef struct LineListRec {
    int line_number;              // Número da linha onde o identificador apareceu
...
typedef struct BucketListRec {
    ...
    ExpressionIdentifier type;       // Tipo do identificador (ex.: Integer, Void)
 ...
 * @param line_number Número da linha onde foi declarado
 ...
 *
 * @param name Nome do identificador
 * @param line_number Número da linha onde foi usado
 */
